...
class App {
    ...
    init() {
        ...
        const texture = Promise.all([texLoader.load( import.meta.env.BASE_URL + 'assets/2_no_clouds_8k.jpeg'), texLoader.load(import.meta.env.BASE_URL + 'assets/2k_earth_specular_map 1.jpg'), texLoader.load(import.meta.env.BASE_URL + 'assets/elev_bump_8k.jpeg')], (resolve, reject) => {
            ...
            earthPlane = new THREE.PlaneGeometry(637.1, 637.1/2, 200, 200);
            ...
            console.log('earthPLane normals');
            console.log(earthPlane.attributes);
...
function render() {
    ...
    // earth.rotation.set(earthRot.x, earthRot.y + Math.PI / 2 * multiplier, earthRot.z);
    // earth.morphTargetInfluences[0] = multiplier;
    // const attributes = computeMorphedAttributes( earth );
    // earth.geometry.setAttribute('normal', attributes.morphedNormalAttribute);
